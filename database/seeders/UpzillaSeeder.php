...
class UpzillaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $upzillas=[
            ...
            'Shariakandi (সারিয়াকান্দি)',
            'Shajahanpur (শাজাহানপুর)',
            'Dupchanchia (দুপচাচিঁয়া)',
            'Adamdighi (আদমদিঘি)',
            'Nondigram (নন্দিগ্রাম)',
            'Sonatala (সোনাতলা)',
            'Dhunot (ধুনট)',
            'Gabtali (গাবতলী)',
            'Sherpur (শেরপুর)',
