...
@section('content')
    ...
    <div class="content-margin">
        ...
        <div class="add-supplier">
            ...
            <form action="{{route('update-role',[$role->id])}}" method="POST" class="add-supplier-form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md ">
                        ...
                        <div class="col-9">
                            ...
                            @foreach ($permissions as $permission)
                                <div class="form-check {{$group->group}} sameline">
                                    <input class="form-check-input {{$group->group}}" type="checkbox" name="permissions[]" value="{{$permission->name}}" id="permission{{$permission->id}}" {{$role->hasPermissionTo($permission->name)? 'checked' : ''}}>
