...
@section('content')
    ...
    <div class="content-margin card shadow-lg mb-5 bg-white rounded">
        ...
        <div class="add-category card-body"> 
            ...
            <form action="{{route('category-update',['id'=>$category->id])}}" method="POST" class="add-category-form" enctype="multipart/form-data">
                @csrf
                <div class="row"> 
                    <div class="col-md ">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" value="{{$category->description}}" id="" rows="2">{{$category->description}}</textarea>
                        <span class="text-danger">
                            @error('description')
                                {{$message}}
                            @enderror
                ...
                <div class="row">
                    <div class="col-md ">
                        ...
                        <input type="file" class="form-control" name="image" value="{{$category->image}}" id="image">
                        <span class="text-danger">
                           @error('image')
                               {{$message}}
                           @enderror 
